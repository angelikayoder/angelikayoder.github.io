...
<html lang="en">
  <head>
    <title>Contact | strapped Bootstrap Theme by Themelize.me</title>
    <meta charset="utf-8">
    ...
    <!-- Plugins required on all pages NOTE: Additional non-required plugins are loaded ondemand as of strapped 2.5 -->
  ...
  <body class="page page-contact navbar-layout-default">
                ...
                <ul class="nav navbar-nav float-lg-right dropdown-effect-fade">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                      ...
                      <a href="grid.html" class="dropdown-item">Grid System</a> <a href="flexbox.html" class="dropdown-item">Flexbox!</a> <a href="colors.html" class="dropdown-item">Theme colors</a> 
                    </div>
                  </li>
        ...
        <div class="container">
          <div class="row text-center text-lg-left">
            ...
            <div class="col-12 col-lg-5 py-2 text-lg-right">
              <a href="https://wrapbootstrap.com/theme/strapped-responsive-website-template-WB0C6D0H4" class="btn btn-lg btn-primary btn-invert btn-rounded py-3 px-4">Get strapped Today<i class="fa fa-arrow-right ml-2"></i></a>
            </div>
          </div>
        </div>
      </div>
    ...
    <footer id="footer" class="p-0">
      ...
      <div class="bg-inverse-dark text-sm py-3">
        <div class="container">
          <div class="row">
            <div class="col-md-6">
              <p class="mb-0">Site template by <a href="strappedtheme.com" class="footer-link">strapped</a> | Copyright 2017 &copy; strapped</p>
            </div>
            <div class="col-md-6">
    ...
    <!-- JS plugins required on all pages NOTE: Additional non-required plugins are loaded ondemand as of strapped 2.5 To disable this and load plugin assets manually simple add data-plugins-manual=true to the body tag -->
    
    <!--Custom scripts & strapped API integration -->
    <script src="assets/js/custom-script.js"></script>
    <!--strapped scripts mainly used to trigger libraries/plugins -->
